...
<form action="">
    ...
    <div className={LoginBodyCss.row}>
        ...
        <div className={LoginBodyCss.col}>
         ...
         <p> Haven’t access to login ? <a href="#">Sign Up</a></p>
      </div>
            ...
            <input type="submit" value="Create Account" className={LoginBodyCss.submitBtns}/>
        ...
        <div className={LoginBodyCss.col}>
            ...
            <p className={LoginBodyCss.orContText}>Or continue with the following options</p>
